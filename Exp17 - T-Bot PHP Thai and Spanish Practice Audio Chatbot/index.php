...
<head>
    ...
    <meta charset="utf-8">
    <title>T-Bot Thai Practice Chatbot</title>
	
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Learn Thai by chatting with a virtual friend">
...
<body>
    ...
    <div class="container w3-animate-opacity">
        <div id="main-image" class="w3-center w3-round w3-padding w3-text-blue">
            ...
            <h4 class="space-letters"><b>Learn Thai by chatting with a virtual friend</b></h4>
        </div>
        <main id="chat" class="texts">
            <div class="message-container">
                <span id="first-chat-block" class="set-color1"><b>&#x2022 T-Bot</b></span>
                <p>Say สวัสดีครั (hello) to get started...</p>
                <ul class="lighter-black instruction-text">
					...
					<li>The translation language can be selected in the settings menu.</li>
                </ul>
            </div>
        ...
        <div class="sticky-bar">
            <form id="myForm" action="main.php" method="post">
                <input id="user-input" type="text" name="my_message" placeholder="Enter a message in Thai..." autofocus>
